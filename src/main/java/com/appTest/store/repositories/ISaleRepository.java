...
public interface ISaleRepository extends JpaRepository <Sale, Long> {
    ...
    @Query("SELECT new com.appTest.store.dto.sale.SaleSummaryByDateDTO(s.dateSale, SUM(s.total), COUNT(s)) " +
    ...
    @Query("SELECT new com.appTest.store.dto.sale.SaleHighestDTO(" +
            "s.client.name, s.client.surname, s.idSale, SIZE(s.materialSaleList), s.total) " +
